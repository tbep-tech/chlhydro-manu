...
load(file = here('tabs/suppaicseltab.RData'))
...
```{r}
#| label: tbl-suppaicseltab
#| tbl-cap: "Comparison of Generalized Additive Models for chlorophyll-a for each bay segment using full models and fit using the select option.  Model fit was assessed using Akaike information criterion [AIC, @akaike1974], with the lowest AIC value by segment shown in bold. df: degrees of freedom; Dev. Expl.: deviance explained; OTB: Old Tampa Bay; HB: Hillsborough Bay; MTB: Middle Tampa Bay; LTB: Lower Tampa Bay."
suppaicseltab
```
