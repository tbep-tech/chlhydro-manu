...
We also agree that the gross percentage changes (i.e., 50% TMDL, twice/200% the TMDL) may not represent realistic scenarios for the reasons the reviewer mentions.  However, we believe are useful as a thought exercise*
